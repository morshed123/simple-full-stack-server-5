...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.am84g.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority`;
...
client.connect(err => {
    ...
    console.log('Database connected succseefully.....');
...
app.get('/', (req, res) => {
    res.send('Hello World! Hiii MAMA I am using Mongo ')
})
